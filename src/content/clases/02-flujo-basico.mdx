...
Resulta que _Git_ prepara un archivo de acuerdo al estado que tenia cuando ejecutas el comando `git add`.
...
<Ejercicio title="Estados y Staging" link="https://create.kahoot.it/details/5ec7a1ba-6d0e-466b-8eed-594c5091cb41" label="Ver Kahoot" badge="01" >
    Entrar al kahoot y esperar el codigo de la sala, o sino presionar la opcion *"Aprende"* para responder de forma individual.
</Ejercicio>

<Ejercicio title="Flujo básico: init, add y commit" link="https://github.com/madmti/git-workshop-labs/raw/refs/heads/main/dist/02-flujo-basico-git.tar.gz" label="Descargar targz" badge="02" >
    - Descargar targz
...
<Ejercicio title="Deshacer, Alias y Remotos" link="https://github.com/madmti/git-workshop-labs/raw/refs/heads/main/dist/03-deshacer-alias-remotos.tar.gz" label="Descargar targz" badge="03" >
    - Descargar targz
...
- [Pro Git - Cap. 2]("https://git-scm.com/book/en/v2/Git-Basics-Getting-a-Git-Repository"): Desde `2.1` a `2.8` (excepto `2.6`, junto con un poco de `2.5` y `2.7`)
