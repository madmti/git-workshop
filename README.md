...
- [CLASE 07 — Flujos remotos + Rebase](https://madmti.github.io/git-workshop/clases/07-remotos/)
- [CLASE 08 — Herramientas avanzadas pt.1: Organizacion](https://madmti.github.io/git-workshop/clases/08-interactividad/)
- [CLASE 09 — Herramientas avanzadas pt.2: Analisis y Reescritura](https://madmti.github.io/git-workshop/clases/09-restauracion/)
...
| CLASE 04 | Internals pt.2: Referencias, HEAD y el DAG | refs, HEAD simbolico, etiquetas, referencias a remotos y packfiles | 30m | dificil | 0 |
| CLASE 05 | Internals pt.3: Mantenimiento y Recuperacion | gc, reflog, fsck, eliminar archivos grandes del historial y variables de entorno | 30m | dificil | 0 |
| CLASE 06 | Branch & Merge en profundidad | Ramificacion, fusion, conflictos y gestion de ramas | 1h | media | 0 |
| CLASE 07 | Flujos remotos + Rebase | Ramas remotas, tracking, fetch/pull/push, rebase y sus peligros | 1h | dificil | 0 |
| CLASE 08 | Herramientas avanzadas pt.1: Organizacion | Seleccion de revision, rangos, cherry-pick, add -p, stash y clean | 1h | dificil | 0 |
| CLASE 09 | Herramientas avanzadas pt.2: Analisis y Reescritura | blame, grep, pickaxe, amend, rebase interactivo, reset, bisect y filter-branch | 1h | dificil | 0 |
